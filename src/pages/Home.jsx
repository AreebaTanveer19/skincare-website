...
import serum from '../assets/images/h1.jpeg';
import cream from '../assets/images/h2.jpeg';
import Cleanser from '../assets/images/h3.jpeg';
import Aboutus from '../assets/images/about.jpeg';

const products = [
  { name: 'Radiance Serum', desc: 'Brightens and revitalizes skin.', img: serum, category: 'Serums' },
  { name: 'Hydra Cream', desc: 'Deep hydration for a dewy glow.', img: cream, category: 'Creams' },
  { name: 'Botanical Cleanser', desc: 'Gentle, natural cleansing.', img: Cleanser, category: 'Cleansers' },
];
  ...
  return (
    <div className="luxury-skincare">
      ...
      <section className="hero">
        ...
        <img src={skincareImg} alt="Luxury skincare" className="hero-bg" loading="lazy" />
      </section>
      ...
      <section className="about" id="about">
        <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="about-content">
          <img src={Aboutus} alt="About us" className="about-img" loading="lazy" />
          <div>
            <h2>About Us</h2>
            <p>
